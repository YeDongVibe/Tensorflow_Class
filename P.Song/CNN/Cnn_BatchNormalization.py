...
model.add(layers.Conv2D(16, (3, 3), activation=act, input_shape = (32, 32, 3))) # 2차원 convolution적용., 흑백이라서 1임. color면 일반적으로 3
...
ret = model.fit(x_train, y_train, epochs=100, batch_size=200, validation_data=(x_test, y_test), verbose=0)
